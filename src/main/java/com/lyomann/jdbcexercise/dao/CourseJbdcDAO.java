package com.lyomann.jdbcexercise.dao;
...
@Component
public class CourseJbdcDAO implements DAO<Course>{

    private static final Logger log = LoggerFactory.getLogger(CourseJbdcDAO.class);
    ...
    public CourseJbdcDAO(JdbcTemplate jdbcTemplate) {
